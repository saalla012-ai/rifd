...
const proofPackets = [
  ...
  },
  {
    ...
    studio: { product: "عباية عملية بتفاصيل أنيقة ومناسبة للدوام والمناسبات", audience: "نساء يبحثن عن إطلالة محتشمة وراقية وسهلة التنسيق", offer: "تشكيلة موسمية جديدة بكميات محدودة", goal: "seasonal", channel: "instagram" },
  ...
  },
  {
    ...
    studio: { product: "بوكس ضيافة فاخر يجمع قهوة وحلوى بتغليف جاهز للإهداء", audience: "عملاء يبحثون عن هدية أنيقة أو ضيافة زيارة سريعة", offer: "حجز مسبق لموسم الزيارات والمناسبات", goal: "seasonal", channel: "whatsapp" },
  ...
  },
  {
    ...
    studio: { product: "خدمة إدارة حملات محتوى لعدة متاجر أو عملاء", audience: "وكالات وفرق تسويق تحتاج تسليم أسرع ومنطق حملة موحد", offer: "جلسة تأهيل لمسار رِفد للأعمال", goal: "retention", channel: "whatsapp" },
  ...
  },
  {
    ...
    studio: { product: "سماعة لاسلكية ببطارية طويلة وعزل ضوضاء للاستخدام اليومي", audience: "طلاب وموظفون يريدون تركيزاً وتنقلاً أسهل", offer: "عرض محدود مع ضمان واستبدال", goal: "offer", channel: "tiktok" },
  ...
  },
  {
    ...
    studio: { product: "طقم مواليد ناعم وآمن للاستخدام اليومي والإهداء", audience: "أمهات وآباء يبحثون عن راحة الطفل وهدية موثوقة", offer: "خصم على أطقم الهدايا الجاهزة", goal: "offer", channel: "snapchat" },
  ...
  },
  {
    ...
    studio: { product: "قطعة ديكور تضيف دفئاً وأناقة لركن القهوة أو غرفة المعيشة", audience: "عملاء يهتمون بتنسيق المنزل والمشاهد الجاهزة للتصوير", offer: "تشكيلة محدودة لموسم التجديد المنزلي", goal: "seasonal", channel: "instagram" },
