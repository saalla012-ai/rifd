...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "رِفد للتقنية — شركة سعودية لأدوات المحتوى والتسويق الذكية" },
      { name: "twitter:image", content: "https://rifd.site/og-image.jpg" },
      { name: "twitter:image:alt", content: "رِفد للتقنية — شركة سعودية لأدوات المحتوى والتسويق الذكية" },
    ],
