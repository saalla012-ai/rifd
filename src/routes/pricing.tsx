...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "الأسعار — 50+ قالب وتحديثات شهرية | رِفد للتقنية" },
      {
        name: "description",
        content:
          "ابدأ مجاناً ثم ارقَ متى ما حبيت. 50+ قالب وتحديثات شهرية، وتجربة أولى قوية، وباقات مصممة للمتاجر السعودية، مع مسار رِفد للأعمال للوكالات والمؤسسات.",
      },
...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    tagline: "الخيار الأذكى لتشغيل محتوى المتجر بشكل مستمر",
    ...
    bonusGroups: [
      ...
      },
      {
        ...
        icon: Palette,
        items: [
          "50+ قالب احترافي مع تحديثات شهرية",
  ...
  },
  {
    ...
    bonusGroups: [
      ...
      },
      {
        ...
        icon: Briefcase,
        items: [
          "وصول برمجي وتكاملات إعلانية ضمن مسار رِفد للأعمال",
          "تهيئة تشغيل مخصصة بحسب احتياج الوكالة أو الفريق",
        ],
      },
      {
        title: "🎁 حصري للمؤسسين",
      ...
      <section className="border-b border-border bg-secondary/30 py-12 sm:py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            تفعيل خلال 24 ساعة من رفع الإيصال • 50+ قالب وتحديثات شهرية • دعم سريع عبر واتساب • ضمان استرجاع 7 أيام
          </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    +150 صورة • +4 ملفات متاجر • +مدير حساب مخصص • طبقة تكاملات ضمن رِفد للأعمال
                  </p>
                </div>
              </div>
