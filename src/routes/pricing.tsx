...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "الأسعار — 50+ قالب وتحديثات شهرية | رِفد للأعمال" },
      {
        name: "description",
        content:
          "ابدأ مجاناً ثم ارقَ متى ما حبيت. 50+ قالب وتحديثات شهرية، وتجربة أولى قوية، وباقات مصممة للمتاجر السعودية ورِفد للأعمال.",
      },
