...
export function CampaignContextBar({ campaign, campaignId, loading, error, summary }: { campaign: CampaignPack | null; campaignId?: string; loading: boolean; error: string | null; summary?: string }) {
