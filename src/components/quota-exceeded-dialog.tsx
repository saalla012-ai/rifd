...
function getVariant(kindOfError: QuotaErrorKind, generationKind: "نص" | "صورة"): Variant {
  ...
  return {
    ...
    subtitle:
      generationKind === "صورة"
        ? "وصلت سقف الصور الشهري — اشحن نقاط إضافية أو ارقَّ الباقة"
        : "وصلت سقف توليد النصوص في باقتك",
    badge: "🔥 عرض المؤسسين: خصم 30% للأعضاء الـ 50 الأوائل",
    cta:
      generationKind === "صورة"
        ? { label: "شحن نقاط فوراً", to: "/dashboard/credits" }
        : { label: "ترقّ باقتك الآن", to: "/dashboard/billing" },
    benefits: [
      "200 توليدة نصية يومياً (مجاناً للجميع)",
      "صور احترافية بنماذج Flash (10 نقاط) و Pro (25 نقطة)",
