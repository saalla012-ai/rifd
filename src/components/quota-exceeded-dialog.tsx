...
function getVariant(kindOfError: QuotaErrorKind, generationKind: "نص" | "صورة" | "فيديو"): Variant {
  if (kindOfError === "text_quota") {
    return {
      ...
      subtitle: "وصلت سقف النصوص اليومي — يتجدّد العدّاد تلقائياً عند منتصف الليل (توقيت الرياض)",
      badge: "💡 احفظ القوالب المفضّلة في مكتبتك لاستخدامها لاحقاً",
      cta: { label: "ترقية لباقة أعلى (حدود أكبر)", to: "/dashboard/billing" },
      benefits: [
        "حدود نصوص أعلى في الباقات المدفوعة",
  ...
  if (kindOfError === "image_quota") {
    return {
      icon: Clock,
      title: "وصلت إلى الحد اليومي للصور",
      subtitle: "لقد وصلت إلى الحد اليومي للصور (7 صور). يمكنك الترقية الآن لتحصل على 30 صورة يوميًا.",
      badge: "💡 يمكنك أيضاً العودة غداً، فالحد اليومي يتجدد تلقائياً بتوقيت الرياض",
      cta: { label: "ترقية للحصول على 30 صورة يومياً", to: "/dashboard/billing" },
      benefits: [
        "30 صورة يومياً في الباقة الأعلى",
        "الصور لا تخصم من نقاط الفيديو",
        "خيارات تحسين وتوليد أكثر خلال اليوم",
