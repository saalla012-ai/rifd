...
function getVariant(kindOfError: QuotaErrorKind, generationKind: "نص" | "صورة" | "فيديو"): Variant {
  ...
  if (kindOfError === "insufficient_credits") {
    return {
      ...
      subtitle: `الفيديو فقط يستهلك النقاط: ${VIDEO_QUALITY_LABELS.fast} بـ${videoCreditCost("fast", 5)} نقطة و${VIDEO_QUALITY_LABELS.quality} بـ${videoCreditCost("quality", 5)} نقطة. اشحن نقاط فيديو أو ارقَّ الباقة.`,
